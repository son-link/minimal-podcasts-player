...
class Ui_configDialog(object):
    def setupUi(self, configDialog):
        ...
        self.iconsSelector = QtWidgets.QComboBox(configDialog)
        self.iconsSelector.setObjectName("iconsSelector")
        self.gridLayout_2.addWidget(self.iconsSelector, 4, 2, 1, 1)
        ...
        self.cbUseMppIcons = QtWidgets.QCheckBox(configDialog)
        self.cbUseMppIcons.setObjectName("cbUseMppIcons")
        self.gridLayout_2.addWidget(self.cbUseMppIcons, 5, 1, 1, 1)
    ...
    def retranslateUi(self, configDialog):
        ...
        self.label_3.setText(_translate("configDialog", "icons:"))
        self.selDownFolder.setText(_translate("configDialog", "Select"))
        self.cbUseMppIcons.setText(_translate("configDialog", "Use mpp icons"))
